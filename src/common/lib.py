...
ADDRESS_BLOCK_MAP = 'address_block_map'

STATE_NAMES = {REG, MEM, FLAGS, FS, CS, DS, ES, GS, STDOUT, FUNC_CALL_STACK, ADDRESS_BLOCK_MAP}
...
class TRACE_BACK_RET_TYPE(Enum):
    ...
    TB_COUNT_EXCEEDS_LIMITATION = 13
